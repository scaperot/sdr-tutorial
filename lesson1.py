...
class lesson1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lesson1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lesson1")
        ...
        self.channel_freq = channel_freq = 101.1e6
        ...
        # Blocks
        ##################################################
        self._channel_freq_range = Range(87.9e6, 107.9e6, 200e3, 101.1e6, 200)
        ...
        self._audio_gain_range = Range(0, 1, 0.001, 1, 200)
